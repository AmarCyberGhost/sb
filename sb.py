...
client = LineClient()
#client = LineClient(authToken='EB8wGRqXlZJjwxyaI7Sd.1EVwB9SElL9pqdhaOdYktq.O0vvs2xhTW2SMpQ6Wc7+7dWcfebCKFh2hVHgVkb7RYk=')
                ...
                if msg.text != None:
                    if msg.toType == 2:
                        ...
                        if may in str(msg.contentMetadata) and 'MENTION' in str(msg.contentMetadata):
                            pilih = ['yang tag sy semoga banyak rezekinya','ngapain tag tag bang Amar kak?, kangen ya?','ada apa ini? ko di tag lagi..?mau kasih duit ya?','duhh kena tag, dianya pasti kesepian.. mau ngajak nikung kali yah','gk usah tag kak.., kirim gift tikel aja']
                        ...
                        if msg.toType == 2:
                            ...
                            if text.lower() == 'me':
                                ...
                                if msg.to in cctv['point']:
                                    ...
                                    client.sendText(msg.to, "Heh bang Amar, udah Pikun ya...? kan belom di Set!!!")
                except Exception as e:
                    ...
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                pref=['eh ada kak','hai kak','nah udah online kak..','jngan ngintip aja kak','lg ngapain','jangan suka jadi CCTV kak','sini chat kak']
