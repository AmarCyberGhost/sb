...
k1 = LINE("EBV8qX1fLTUeOOgTTnXd.1EVwB9SElL9pqdhaOdYktq.RWwC3TlYDsHIcgb/jT7F1bMJjsV/rPOvrK3BpyjnOZI=")
...
MVps ="""╔═══════𖤓Ready𖤓════════
║𖤓Price VPS Gooogle Cloud𖤓
╠[★]1 Core 1GB RAM 150k/Bulan
╠[★]1 Core 2GB RAM 200k/Bulan
╠[★]1 Core 3GB RAM 300k/Bulan
╠[★]1 Core 4GB RAM 350k/Bulan
╠[★]1 Core 5GB RAM 400k/Bulan
║
║Pembayaran Via :
╠[★]Bank BCA Atau BNI
║
...
OWNER=["ud5ebd66fdb1e2e5f4f4031c0a03c8a4d"] #Koplaxs
admin=["ud5ebd66fdb1e2e5f4f4031c0a03c8a4d"] #Koplaxs
  
staff=[
  "ub2b15309fe956c101de0dc81116e94c2", #Mars
  "u90dd8f393db07686209746785610b535", #Mars
  "u86bb6b878139a53ea80cb4561e8f19a8", #Suci LYR
  "u8c3d71d73999d55da03e8d74fb24b77d", #Rigel LYR
  "u019c76b8366990aa14ea686cc1b17a05", #Bagus LYR
  "u01716ef578892c197d37837c4fb4a159", #Arien
  "u77894580e9ceb271499910b6dc25355a"] #Nuy
#================
msg_dict = {}
cctv = {
    "cyduk":{},
    ...
    try:
        ...
        if op.type == 5:
          if wait["autoAdd"] == True:
              ...
              k1.sendMessage(op.param1, "MAKASIH UDAH DI ADD BOSS")
              k1.sendContact(op.param1, 'ued156c86ffa56024c0acba16f7889e6d')
                    ...
                    if text is None:
                        ...
                        if msg.text in ["Absen","Absen bot","Absen dulu","Respon"]:
                         if msg._from in admin:
                          k1.sendMessage(msg.to,"𖤓[̲̲̅̅Cyber Ghost]𖤓")
                        ...
                        if koplaxs == "help":
                        ...
                        elif msg.text in ["Price vps","price vps"]:
                         if msg._from in OWNER:
                           if wait["lang"] == "JP":
                         ...
                         if msg._from in OWNER:
                        ...
                        elif koplaxs.startswith("sendmp4 "): 
                          if sender in OWNER:
                            separate = text.split(" ")
                            linknya = text.replace(separate[0] + " ","")
                            k1.sendVideoWithURL(to, linknya)
                        elif koplaxs.startswith("sendmp3 "): 
                          if sender in OWNER:
                            separate = text.split(" ")
                            linknya = text.replace(separate[0] + " ","")
                          ...
                          if sender in admin:
                            ...
                            owner = "ubaba90be636d918cab5509685cef5c23"
                            ...
                            aboter += "\n║╠ Creator id :  http://line.me/ti/p/~hanavy1992"
                            aboter += "\n╚╩━━[Succes]━━╩━╯"
 ...
 #============== TEST CCTV DAN SIDER =========================
                            ...
                            if sender in admin:
                              if msg.to in wait2['readPoint']:
                               ...
                               k1.sendMessage(msg.to, "Ketik Cctv Dulu Boss\nBaru Ketik Ciduk\nDasarBoss Amar Pikun ♪")
                          ...
                          if sender in admin:
                            ...
                            wait["Sider"] = True
                            k1.sendMessage(msg.to,"Siap On Cek Sider")
        ...
        if op.type == 26:
          ...
          if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True: 
                    ...
                    balas = ["Kenapa Tag Si "+k1.getProfile().displayName+"Kangen yah..!!!\nPC aja langsung  biar anu hihi..!!\n[autoRespon]","Nah ngetag lagi si "+k1.getProfile().displayName+" mending ajak mojok aja Bang Amar dari pada ngetag mulu.. wkwk...!!!\n[autoRespon]"]
                    balas = [cName + "\n[Auto Respon]\nAda Apa? \nBoss Amar Lagi Sibuk!! ",cName + "\n[Auto Respon]\nBoss Amar Lagi Kojum",cName + "\n[Auto Respon]\nJones Ngetag²!",cName + "\n[Auto Respon]\nSorry \nBang Amar Lagi Baper",cName + "\n[Auto Respon]\nNah Tag Gw Pasti Mau Kasih Gw Duit Ya...!!",cName + "\n[Auto Respon]\nMaaf Boss, Lagi Sibuk, ntar Aja kojomnya"]
                    path = "http://dl.profile.line-cdn.net/" + contact.pictureStatus                
